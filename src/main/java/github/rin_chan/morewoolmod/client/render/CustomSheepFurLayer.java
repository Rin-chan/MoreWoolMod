	   ...
	   if (!p_117424_.isSheared()) {
         if (p_117424_.isInvisible()) {
            ...
            if (p_117424_.hasCustomName() && "jeb_".equals(p_117424_.getName().getString())) {
               ...
               float[] afloat1 = CustomSheep.getColorArray(DyeColor.byId(k));
               float[] afloat2 = CustomSheep.getColorArray(DyeColor.byId(l));
               f = afloat1[0] * (1.0F - f3) + afloat2[0] * f3;
               f1 = afloat1[1] * (1.0F - f3) + afloat2[1] * f3;
               f2 = afloat1[2] * (1.0F - f3) + afloat2[2] * f3;
            } else {
               float[] afloat = CustomSheep.getColorArray(p_117424_.getColor());
               f = afloat[0];
               f1 = afloat[1];
               f2 = afloat[2];
            }
